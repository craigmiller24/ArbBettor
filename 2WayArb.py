...
if __name__ == "__main__":
    ...
    if st.button("Calculate Optimal Stakes"):
        ...
        if bets is None:
            ...
            data = {
                "Bet 1": [o1, stake1, f"{down(stake1 * o1)} ({down((stake1 * o1) - stake1)})", f"{down(-stake1)} ({down(-stake1)})"],
                "Bet 2": [o2, stake2, f"{down(-stake2)} ({down(-stake2)})", f"{down(stake2 * o2)} ({down((stake2 * o2) - stake2)})"]
            }
